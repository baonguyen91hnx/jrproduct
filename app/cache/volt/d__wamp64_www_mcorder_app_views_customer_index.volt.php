...
<div class="row">
    <div class="col-md-4 ">
        <a href="<?= $this->url->get('customer/add') ?>" class="btn btn-primary" />Thêm Khách Hàng Mới</a>
    </div>
    <div class="col-md-4 col-md-offset-4">
        <form class="form-inline" method="post" action="<?= $this->url->get('index/search/customer') ?>">
                ...
                <tbody>
                    <?php foreach ($customers as $customer) { ?>
                        <tr>
                            ...
                            <td>
                                <a href="<?= $this->url->get('customer/view/?id=' . $customer->id) ?>" class="btn btn-success">Xem</a>
                                <a href="<?= $this->url->get('customer/edit/?id=' . $customer->id) ?>" class="btn btn-primary">Sửa</a>
                                <a onclick="return confirm('Bạn có chắc chắn khi xóa đối tác này?');" href="<?= $this->url->get('customer/delete/?id=' . $customer->id) ?>" class="btn btn-danger">Xóa</a>
                            </td>
                        </tr>
                    <?php } ?>
                </tbody>
