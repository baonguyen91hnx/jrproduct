        ...
        <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
            <div class="menu_section">
                ...
                <ul class="nav side-menu">
                    ...
                    <li><a><i class="fa fa-table"></i> Slam <span class="fa fa-chevron-down"></span></a>
                        <ul class="nav child_menu">
                            <li><a href="<?= $this->url->get('slam/index') ?>">Quản Lý</a></li>
                            <li><a href="<?= $this->url->get('slam/add') ?>">Thêm Mới</a></li>
                            <li><a href="<?= $this->url->get('slam/log') ?>">Thống Kê</a></li>
                        </ul>
                    </li>
...
<div class="row">
    <div class="page-header">
        <h1>Trang Quản Lý Chức Vụ </h1>
    </div>
    <ol class="breadcrumb">
        <li><a href="#">Trang Chủ</a></li>
        <li class="active">Quản Lý Chức Vụ</li>
    </ol>
</div>
<div class="row">
    <div class="col-md-4 ">
        <a href="<?= $this->url->get('role/add') ?>" class="btn btn-primary" />Thêm Chức Vụ Mới</a>
    </div>
    <div class="col-md-4 col-md-offset-4">
        <form class="form-inline" method="post" action="<?= $this->url->get('index/search/role') ?>">
